/**
 * @file
 * @brief [H.265](https://en.wikipedia.org/wiki/High_Efficiency_Video_Coding) NAL representation.
 *
 ...
 * @param[out] buffer The memory area capable of storing #SMOLRTSP_H265_FU_HEADER_SIZE bytes.
